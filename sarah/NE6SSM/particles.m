...
ParticleDefinitions[GaugeES] = {
      ...
      {SsbarR,  { Description -> "Sbar SM Singlet",
                  ...
                  LaTeX -> "\\bar{S}_R",
                  OutputName -> "SsbR"}},
      {SphiR,  { Description -> "Pure gauge singlet Singlet",
                  FeynArtsNr -> 669, 
                 LaTeX -> "\\phi_R",
                 OutputName -> "SphiR"}},
   ...
   {Hp0,    { Description -> "Neutral Prime-Higgsinos",
      ...
      {FDx2,        { Description -> "Dirac Right Exotics",
		     ...
		     FeynArtsNr -> 661,
		     OutputName -> "Dx2"}},
      {FSI1,        { Description -> "Dirac Left new Singlino",
		     FeynArtsNr -> 812,
  		     LaTeX -> "\\tilde{s}_L",
		     OutputName -> "FSL"}},
      {FSI2,        { Description -> "Dirac Right new Singlino",
		     FeynArtsNr -> 813,
  		     LaTeX -> "\\tilde{s}_R",
		     OutputName -> "FSR"}},
  ...
  ParticleDefinitions[EWSB] = {
     ...
     {ChiI, { Description -> "Inert Neutralinos",
              PDG -> {1000081,1000082,1000083,1000084, 1000085, 1000086, 1000087},
              Mass -> Automatic,
              FeynArtsNr -> 13,
              ElectricCharge -> 0,
     ...
     {ChaI, { Description -> "Inert Charginos",
              PDG -> {1000088,1000089, 1000181, 1000182},
              Mass -> Automatic,
              ElectricCharge -> -1,
              FeynArtsNr -> 14,
              ...
              OutputName -> "AI"}},
     (* 
      added fake pdg codes here that may be problematic.  should fix later 
      *)
     ...
     {SHI0, { Description -> "Neutral Inert-Higgs",
              PDG -> {82,86,84,88,9994453,9994454,9994455},
               FeynArtsNr -> 7,
               ElectricCharge -> 0,
               LaTeX -> "h^{0,Inert}",
               OutputName -> "HNI"}},
     ...
     {FSI,    { Description -> "Inert-Singlino",
      ...
      {Chi,  { Description -> "Neutralinos",
               PDG -> {1000022,1000023,1000025,1000035,1000045,1000055, 1000065,1000075 },
 ...
 WeylFermionAndIndermediate = {
       ...
       {sigmaSbar,      {Description -> "Scalar SM SingletBar" }}  ,          
       {phiSbar,      { Description -> "Pseudo SM Scalar SingletBar"}},
       {sigmaPhi,      {Description -> "Scalar pure Singlet phi" }},          
       {phiPhi,      { Description -> "Pseudo pure Scalar Singlet phi"}},
